...
static void ste_dump(struct seq_file *m, struct device *dev, struct arm_smmu_ste *ste)
{
	int i;
...
static void cd_dump(struct seq_file *m, struct device *dev, struct arm_smmu_cd *cd)
{
	int i;
