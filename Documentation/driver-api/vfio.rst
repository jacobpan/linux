...
VFIO NOIOMMU mode
-------------------------------------------------------------------------------
VFIO also supports a "no-IOMMU" mode, which is intended for platforms where unsafe
DMA can be used for userspace drivers w/o physical IOMMU protection. This mode is
controlled by the parameter:
/sys/module/vfio/parameters/enable_unsafe_noiommu_mode

However, the capabilities vary depending on the programming interface and kernel
