...
#define test_cmd_hwpt_alloc_external(device_id, viommu_id, hwpt_id, data,        \
				   data_len)                                  \
	ASSERT_EQ(0, _test_cmd_hwpt_alloc(self->fd, device_id, viommu_id, 0,   \
					  0, hwpt_id,                        \
					  IOMMU_HWPT_DATA_EXTERNAL, data,      \
					  data_len))
#define test_err_hwpt_alloc_external(_errno, device_id, viommu_id, flags,        \
