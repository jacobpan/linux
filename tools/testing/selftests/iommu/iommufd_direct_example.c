 ...
 *
 * Run as:
 *   ./iommufd_direct_example /dev/vfio/devices/vfioN <vm-device-id>
 *
...
static int attach_direct_hwpt(int vfio_cdev_fd, uint32_t hwpt_id)
{
...
static void print_direct_attach_ids(uint64_t vm_device_id,
...
int main(int argc, char *argv[])
{
	...
	rc = attach_direct_hwpt(vfio_cdev_fd, direct_hwpt_id);
	if (rc)
		goto out;
	attached = 1;

	print_direct_attach_ids(vm_device_id, dev_id, viommu_id,
